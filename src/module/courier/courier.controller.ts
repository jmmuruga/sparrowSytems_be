...
import { addCourier, courierStatus, deletecourierDetails, getCourier } from "./courier.services";
...
courierRouter.put('/updatestatus/:status/:id',(req, res) => {  courierStatus(req, res);
});
